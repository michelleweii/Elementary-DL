...
After 70 steps, per token cost is 6.905
After 80 steps, per token cost is 6.671
After 90 steps, per token cost is 6.431
After 100 steps, per token cost is 6.463
After 110 steps, per token cost is 6.407
After 120 steps, per token cost is 6.348
After 130 steps, per token cost is 6.528
After 140 steps, per token cost is 6.245
After 150 steps, per token cost is 6.021
...
In iteration: 4
...
'''